...
import re
from verifier import verify_final_answer
...
def main():
    while True:
        ...
        ok = verify_final_answer(user_input, result["messages"])
        
        if not ok:
            print("AI> I couldn't verify that result reliably. Please restate the question with exactly two numbers.")
            continue
